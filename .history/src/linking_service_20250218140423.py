...
class LinkingAgent:
    def __init__(self, base_url: str):
        ...
        fetch_posts_tool = Tool(
            ...
            description=f"Fetches all available blog posts from the sitemap. Pass {{\"base_url\": \"{self.base_url}\"}} to get posts from this domain."
        )
...
- Space out links naturally in the content"""
    ...
    def suggest_internal_links(self, post_content: str) -> str:
        ...
        try:
            ...
            Make sure all suggested links are from {self.base_url}
...
def main():
    ...
    agent = LinkingAgent(base_url="https://example.com")  # Replace with your actual domain
