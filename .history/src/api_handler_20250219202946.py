import src.services.content_generator as content_generator
import src.services.media_service as media_service
import src.services.linking_service as linking_service
import asyncio

class ContentAPIHandler:
    def __init__(self):
        self.blog_generator = content_generator.BlogGenerator()
        self.media_handler = media_service.PostWriterV2()
