...
1. Envision the ideal media
   ...
   - Consider what would best serve the reader at this specific point
   - Think about the complexity of the concept being explained
...
2. Evaluate available tools:
   ...
   - FetchVideos Tool: Finds existing YouTube content
     ...
     * Best when: processes need to be shown in action
     * Not suitable for: hypothetical scenarios or abstract concepts
...
Return a JSON array of media placements, each containing:
...
- Space out media placements evenly throughout the content
- Limit media to 3 placements maximum
- Do Not add media to the beginning of the post
- Ensure each media addition serves a clear educational purpose"""
