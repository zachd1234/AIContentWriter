...
Return your response as a JSON array of link suggestions, even if you only find one suitable link."""
    ...
    def suggest_internal_links(self, post_content: str) -> str:
        ...
        try:
            ...
            First use FetchPosts to get the available posts, then analyze the content and suggest relevant internal links.
