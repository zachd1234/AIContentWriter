...
class ProspectGenerator:
    ...
    def generate_website_list(self, search_term: str, category: str, all_websites: set) -> List[Dict[str, Any]]:
        ...
        category_websites = self.clean_website_list(category_websites, search_term, category)

        print(f"Found {len(category_websites)} unique websites for '{category}'")
        return category_websites
    
    def clean_website_list(self, websites: List[Dict[str, Any]], search_term: str, category: str) -> List[Dict[str, Any]]:
        """
        ...
        if filtered_websites:
            ...
            for website in filtered_websites:
                if self.is_website_relevant(website, category):
    ...
    def is_website_relevant(self, website: Dict[str, Any], category: str) -> bool:
        """
        ...
        Based on the information above, is this website a good candidate for reaching out about a guest post related to {category}?
