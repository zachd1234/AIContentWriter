...
class ProspectGenerator:
    ...
    def is_website_relevant(self, website: Dict[str, Any], category: str, core_phrase: str) -> bool:
        ...
        Consider:
        1. Does this website have a blog?
        2. Is it relevant to the category "{category} and somewhat relevant to {core_phrase}"?
        
        Answer with ONLY "yes" if it's a good candidate or "no" if it's not. Be generous with the yes but remove obvious no's that are not good fits. 
        """
