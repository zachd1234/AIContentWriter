    ...
    def analyze_website(self, url: str) -> str:
        ...
        try:
            ...
            if not scraped_data or 'content' not in scraped_data:
                ...
                return "Unable to analyze website: Failed to scrape content."
            
            webpage_content = scraped_data.get('content', '')
...
1️⃣ Target Audience: Who is this website's main audience? Be specific (e.g., expert hikers, parents of young athletes, corporate professionals).
