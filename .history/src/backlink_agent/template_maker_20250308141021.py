...
"""
    ...
    def create_template(self, template_type: str, site_id: int) -> str:
        """
        Create an email template based on the specified type and site ID.
        ...
        """
        logger.info(f"Creating template of type: {template_type} for site ID: {site_id}")
...
if __name__ == "__main__":
    ...
    try:
        body = template_maker.create_template("gemini_personalized", site_id)
