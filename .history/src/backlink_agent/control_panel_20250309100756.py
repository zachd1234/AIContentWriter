...
class ControlPanel:
    ...
    def setup_outreach(self, blog_title: str, blog_description: str, site_id: int) -> Dict[str, Any]:
        """
        Set up outreach by clearing existing prospect URLs and generating new ones.
        
        This control panel method:
        1. Clears all existing prospect URLs for the specified site_id
        2. Generates a new complete prospect report
        3. Saves the new prospects to the database
        ...
        """
        # Step 1: Clear existing prospect URLs for this site
        ...
        # Step 2: Generate new prospect report using the prospect generator
