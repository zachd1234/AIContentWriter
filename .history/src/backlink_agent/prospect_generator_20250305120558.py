...
class ProspectGenerator:
    ...
    def generate_website_categories(self, blog_title: str, blog_description: str) -> str:
        ...
        - Gardening blog sites (include websites in the same niche as our blog)        
    ...
    def structure_categories_to_search_terms(self, categories_text: str, core_phrase: str) -> List[Dict[str, str]]:
        ...
        The search query should be specific enough to find relevant websites but general enough to return a good number of results. If a specifc category should be broken into mutiple categories, do that.  
        """
