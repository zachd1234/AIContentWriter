...
class ProspectGenerator:
    ...
    def get_autocomplete_suggestions(self, query: str, max_suggestions: int = 10) -> List[str]:
        ...
        try:
            ...
            # Extract suggestions and limit to max_suggestions
            suggestions = [item.get("query", "") for item in autocomplete_results.get("suggestions", [])]
...
def main():
    ...
    # Only run the full prospect generation if requested
