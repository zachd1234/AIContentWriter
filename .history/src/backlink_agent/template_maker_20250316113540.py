...
"""
            ...
            # Generate the outreach angle with proper configuration
            generation_config = GenerationConfig(
                temperature=0.7,
                top_p=0.95,
                top_k=40,
            ...
            # Make the API call
            response = model.generate_content(
                contents=outreach_angle_prompt,
                generation_config=generation_config
            )
            ...
            return f"Error generating outreach angle: {str(e)}"
