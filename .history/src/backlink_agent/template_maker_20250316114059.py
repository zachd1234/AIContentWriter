...
{webpage_content}"""
    ...
    def generate_advanced_personalized_email(self, url: str, site_id: int) -> str:
        ...
        try:
            ...
            outreach_angle_prompt = f"""Act as an expert in content outreach strategy. Your task is to generate ONE strong outreach angle that connects our blog topic to the target website's audience.
...
-Return ONE outreach angle with no other text or explainations.
...
"""
            ...
            research_model = GenerativeModel("gemini-1.5-flash-002")
