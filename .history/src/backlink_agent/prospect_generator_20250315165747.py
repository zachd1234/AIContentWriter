...
class ProspectGenerator:
    ...
    def get_category_list(self, post_url: str, post_title: str) -> str:
        ...
        try:
            # Get categories from database or generate them
            ...
            2. Represent the best category for outreach for this post
            3. Be most likely to result in successful backlinks
