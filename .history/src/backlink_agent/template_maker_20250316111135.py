...
{webpage_content}"""
    ...
    def generate_advanced_personalized_email(self, url: str, site_id: int) -> str:
        ...
        try:
            ...
            # Create prompt for Gemini with the website analysis
            prompt = f"""
...
Use this template structure, but personalize it based on their blog content and the website analysis:

My name is {founder_name} and I am the founder of {blog_name}.

[Insert 1-2 sentences showing genuine appreciation for their specific content or approach based on the website analysis]

Your readers can benefit from [how their readers can benefit from this blog's content based on the website analysis]. Here's a sample of my most recent work: {recent_work_url}
...
3. Be specific about how their readers can benefit from my content
