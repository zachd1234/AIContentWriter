...
REACT_CHAT_SYSTEM_PROMPT = """You are an expert outreach strategist and email writer. Your task is to generate a personalized outreach email for a blog outreach campaign.

You have access to tools that can help you generate an outreach angle and create a personalized email.

Follow these steps:
1. Generate an outreach angle that connects our blog to the target website's audience
2. Use that outreach angle to create a personalized outreach email
3. Return the final email text

Use the tools provided to accomplish this task efficiently."""
...
if __name__ == "__main__":
    ...
    for url in test_urls:
        ...
        try:
            analysis = template_maker.generate_advanced_personalized_email_agentic(url, 1)
            print(analysis)
        except Exception as e:
