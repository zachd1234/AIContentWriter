...
class GetImgAIClient:
    ...
    def generate_image(self, prompt: str) -> str:
        ...
        try:
            ...
            getimg_url = self.generate_google_image(detailed_prompt)
    ...
    def generate_google_image(self, prompt: str) -> str:
        ...
        try:
            ...
            # Step 2: Generate and upload image using Google Imagen API
            media_urls = self.imagen_api.upload_to_wordpress(detailed_prompt, self.base_url)
            
            if media_urls and len(media_urls) > 0:
                print(f"✅ Generated and uploaded image with Google Imagen. URL: {media_urls[0]}")
                return media_urls[0]
            else:
                print("❌ Failed to generate image with Google Imagen, falling back to GetImg")
