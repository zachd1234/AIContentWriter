...
from langchain.tools import DuckDuckGoSearchRun  # For search functionality
...
class ContentGenerator:
    def __init__(self):
        ...
        search_tool = Tool(
            ...
            description="Searches the web for current information about the topic"
        )

        # Initialize the agent with all tools
        self.agent = initialize_agent(
            tools=[research_tool, serp_tool, search_tool],
            llm=self.llm,
...
def main():
    ...
    post = generator.generate_blog_post("How Much Weight Should I ruck With?")
