    ...
    def enhance_post(self, blog_post: str) -> str:
        ...
        try:
            ...
            try:
                ...
                json_str = self.extract_json_from_agent_output(output_text)
