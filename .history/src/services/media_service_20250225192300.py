...
class PostWriterV2:
    ...
    def validate_json_response(self, agent_output: str) -> str:
        ...
        try:
            ...
            # First, try to clean up the output if it's wrapped in markdown code blocks
            # Handle both three and four backtick cases
