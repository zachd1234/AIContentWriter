...
class PostWriterV2:
    ...
    def validate_json_response(self, agent_output: str) -> str:
        """Validates the JSON format and filters out hallucinations using JSON mode principles"""
        try:
            ...
            # Normalize the media items to our expected format
            normalized_items = []
            for item in media_items:
                ...
                if "type" in item:
                    ...
                    normalized_item["type"] = item["mediaType"]
                else:
