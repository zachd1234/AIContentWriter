...
class BlogGenerator:
    def __init__(self):
        ...
        self.model = genai.GenerativeModel('gemini-pro')  # Using stable model
    ...
    def generate_blog_post(self, keyword: str) -> dict:
        ...
        try:
            # Configure Google Search grounding with temperature 0.0 as recommended
            response = self.model.generate_content(
                ...
                tools=[{
                    "google_search_retrieval": {}  # Basic search configuration
                }]
            )
