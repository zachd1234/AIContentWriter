...
class ContentAPIHandler:
    ...
    def test_media_population(self, keyword: str) -> dict:
        """
...
def main():
    ...
    result = handler.test_media_population("What is a Phase I Environmental Site Assessment?")
    
    if result and result["status"] == "success":
        print("\nGenerated Post with Media:")
        print("-" * 50)
        print(result["data"])
    else:
        print("Failed to generate post with media")
        if result:
