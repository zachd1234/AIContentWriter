...
class DatabaseService:
    ...
    def pop_next_urls(self, max_count: int, site_id: int) -> List[Dict[str, Any]]:
        ...
        try:
            # Get the top URLs for the specified site
            cursor.execute(
                """
            ...
            # Get the minimum priority for this site to place these at the back
            cursor.execute("SELECT MIN(priority) FROM outreach_urls WHERE site_id = ?", (site_id,))
