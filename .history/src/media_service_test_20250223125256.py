...
class PostWriterV2:
    ...
    def enhance_post(self, blog_post: str) -> str:
        ...
        try:
            ...
            Follow these steps to enhance the post with media placements (3 max):
            
            1. First pass: Read through the entire blog post and identify all potential locations where media could enhance understanding.

            2. Selection phase: From these potential locations, select the 2-3 best opportunities where media would be most impactful.
               Consider:
            ...
            3. For each selected location:
                Envision what would best help readers understand the content at this point. 
            ...
            4. Return your suggestions as a JSON array where each object contains:
