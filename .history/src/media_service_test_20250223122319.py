...
class PostWriterV2:
    def __init__(self):
        ...
        def generate_image_with_url(prompt: str, base_url: str) -> str:            return self.img_client.generate_image(prompt, base_url=base_url)
...
def main():
    ...
    test_vision = "A video explaining the best rucking backpacks"
