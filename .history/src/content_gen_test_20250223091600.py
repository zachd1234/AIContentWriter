...
class ContentGenerator:
    ...
    def research_topic(self, keyword: str) -> dict:
        ...
        and identify the most crucial information that someone needs to understand about this topic.

        Please provide:
        1. 5 key findings or main points
        2. 3-5 important statistics or facts (with sources if available)
