...
class PostWriterV2:
    ...
    def format_json_response(self, agent_output: str) -> str:
        ...
        try:
            format_prompt = f"""
            Take this agent output and convert it to a properly formatted JSON array.
            Include ONLY media that was actually generated (has a real URL).
            
            Agent output:
            {agent_output}
            
            Return a JSON array where each object has:
            - 'insertBefore': exact text where media should be inserted
            - 'mediaType': either 'image' or 'video'
            - 'mediaUrl': the URL that was generated
            - 'description': explanation of how this media enhances understanding
