...
1. Look ONLY for natural break points between paragraphs or sections where media would genuinely enhance the content
2. For each potential placement, carefully consider:
...
3. If the placement meets these criteria, decide whether an image or video would be more effective:
   - For images: Use GenerateImage tool for visual illustrations that help people visualize the topic 
   - For videos: Use FetchVideos tool for demonstrations, processes, or expert explanations
...
- Limit media to 4 placements maximum
