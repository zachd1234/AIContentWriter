...
class ApolloClient:
    ...
    def search_people(self, domain: str, page: int = 1, per_page: int = 10) -> List[Dict[str, Any]]:
        """
        Search for people associated with a domain.
    ...
    def get_person_from_url(self, url: str) -> Optional[Dict[str, Any]]:
        ...
        people = self.search_people(domain, per_page=1)
...
if __name__ == "__main__":
    ...
    print(f"\nTesting direct domain search: {test_domain}")
    
    # Search people by domain
    people = client.search_people(test_domain, per_page=3)
    ...
    if people:
        ...
        print("No people found for the given domain.")