...
class BlogGenerator:
    def __init__(self):
        ...
        self.model = genai.GenerativeModel('gemini-2.0-flash')  # Create model instance
    ...
    def generate_blog_post(self, keyword: str) -> dict:
        ...
        try:
            # Configure Google Search grounding according to pay-as-you-go documentation
            response = self.model.generate_content(  # Use model instance method
                contents=prompt,
