...
class BlogGenerator:
    ...
    def generate_outline(self, keyword: str) -> List[str]:
        prompt = (
            f"Generate an outline for a blog post targeting the keyword '{keyword}' and satisfy the search intent "
            f"of the target audience"
...
if __name__ == "__main__":
    ...
    result = generator.generate_blog_post(
        keyword="How much weight should I ruck",
    )
